...
def get_pie_chart(entered_site):
   if entered_site == 'ALL':
      ...
      filtered_df = site_df.groupby('class')['Launch Site'].count().reset_index()
...
def get_scatter_chart(entered_site, entered_range):
   if entered_site == 'ALL':
      filtered_df = spacex_df[spacex_df['Payload Mass (kg)'].between (entered_range)]
      ...
      filtered_df = spacex_df[(spacex_df['Launch Site']==entered_site) & (spacex_df['Payload Mass (kg)'].between (entered_range))]
